...
*T = 0; T++;*T = 0; T++;*T = 0; T++;*T = 0; T++;*T = 0; T++;*T = 0; T++;*T = 0; T++;*T = 0; T++;*T = 0; T++;*T = 0; T++;*T = 0; T++;*T = 0; 
    /*
    ...
    *T = s234*c5*c6 - c234*s6; T++;
    *T = 0; T++;// (s234*c5*s6 - (c234*c6+s234*s6)/2.0 - (c234*c6-s234*s6)/2.0); T++;
